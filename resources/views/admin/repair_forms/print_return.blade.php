...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .header-left img { width:44mm; height:auto; display:block; }
        .header-right img { width:44mm; height:auto; display:block; }
        .title {
            text-align: center;
            font-weight: 700;
            margin-top: 4mm;
...
<body>
    <div class="sheet">
        ...
        <div class="doc-date">
            TP.HCM, Ngày {{ ($repairForm->actual_return_date ?: $repairForm->created_at)->format('j') }} Tháng {{ ($repairForm->actual_return_date ?: $repairForm->created_at)->format('n') }} Năm {{ ($repairForm->actual_return_date ?: $repairForm->created_at)->format('Y') }}
        </div>
