...
<div class="page">
    <div class="top">
        <div class="top-left">
            <img src="{{ public_path('logo1.png') }}" class="logo" alt="logo">
        </div>
        <div class="top-right">
 ...
 <p>Báo giá này chỉ có hiệu lực trong vòng 15 ngày kể từ ngày báo giá.</p>
    ...
    <p>Các đơn hàng dự án, vui lòng liên hệ với nhân viên kinh doanh để thỏa thuận các điều khoản thanh toán và giao hàng cụ thể theo hợp đồng mua bán.</p>
