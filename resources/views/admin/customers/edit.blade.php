...
<div class="container-fluid py-4">
    <div class="mb-4" style="display:flex; align-items:center; justify-content:space-between; gap: 12px; flex-wrap: wrap;">
        <h2 class="mb-0">Sửa khách hàng</h2>
        <div style="display:flex; gap: 10px; flex-wrap: wrap;">
            <a href="{{ route('admin.customers.show', $customer) }}" class="btn btn-outline-primary">Xem</a>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="position-relative">
                            <input type="text" name="tax_id" class="form-control" value="{{ old('tax_id', $customer->tax_id) }}" maxlength="255">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="business_type" class="form-control" value="{{ old('business_type', $customer->business_type) }}" maxlength="255">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-bold">Người đại diện</label>
                        <input type="text" name="representative" class="form-control" value="{{ old('representative', $customer->representative) }}" maxlength="255" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="tax_address" class="form-control" rows="2">{{ old('tax_address', $customer->tax_address) }}</textarea>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="phone" class="form-control" value="{{ old('phone', $customer->phone) }}" maxlength="30">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="invoice_recipient" class="form-control" value="{{ old('invoice_recipient', $customer->invoice_recipient) }}" maxlength="255">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="managed_by" class="form-control" value="{{ old('managed_by', $customer->managed_by) }}" maxlength="255">
                    </div>
                    <div class="col-12">
                        <label class="form-label fw-bold">Ngành nghề chính</label>
                        <textarea name="main_business" class="form-control" rows="2">{{ old('main_business', $customer->main_business) }}</textarea>
                    </div>
                </div>
