...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="borrowRequestForm" action="{{ route('admin.borrow-requests.store') }}" method="POST">
                @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="customerName" name="customer_name" class="form-control" value="{{ old('customer_name') }}" maxlength="255" list="customerDatalist" autocomplete="off">
                                        <datalist id="customerDatalist"></datalist>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Người liên hệ</label>
                                        <input type="text" id="contactName" name="contact_name" class="form-control" value="{{ old('contact_name') }}" maxlength="255">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Số điện thoại</label>
                                        <input type="text" id="contactPhone" name="contact_phone" class="form-control" value="{{ old('contact_phone') }}" maxlength="30">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Mã số thuế</label>
                                        <input type="text" id="taxCode" name="tax_code" class="form-control" value="{{ old('tax_code') }}" maxlength="255">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="requested_by_name" class="form-control" value="{{ old('requested_by_name') }}" maxlength="255">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Bộ phận</label>
                                        @php $dep = old('department'); @endphp
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="purpose" class="form-control" value="{{ old('purpose') }}" maxlength="255">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label fw-bold">Công nợ hiện tại</label>
                                        <input type="text" name="current_project" class="form-control" value="{{ old('current_project') }}" maxlength="255">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Thời gian mượn từ</label>
                                        <input type="date" name="borrow_from" class="form-control" value="{{ old('borrow_from') }}" id="borrowFrom">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Đến</label>
                                        <input type="date" name="borrow_to" class="form-control" value="{{ old('borrow_to') }}" id="borrowTo">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="status" class="form-select" required>
                                            @foreach($statusOptions as $k => $label)
                                                <option value="{{ $k }}" {{ old('status','proposed')===$k ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex align-items-center gap-3" style="min-height: 38px;">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="deposit_text" id="depositNone" value="Không cọc" {{ old('deposit_text','Không cọc')==='Không cọc' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="depositNone">Không cọc</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="deposit_text" id="depositYes" value="Có cọc" {{ old('deposit_text')==='Có cọc' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6" id="depositAmountWrap" style="display:none;">
                                        ...
                                        <input type="hidden" name="deposit_amount" value="{{ old('deposit_amount') }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Ký duyệt (tên)</label>
                                        <input type="text" name="approved_by_name" class="form-control" value="{{ old('approved_by_name') }}" maxlength="255">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card shadow-sm mt-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i> Lưu phiếu</button>
                        </div>
                    </div>
                </div>
            </form>
