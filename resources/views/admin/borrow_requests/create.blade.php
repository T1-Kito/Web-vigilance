...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form action="{{ route('admin.borrow-requests.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="customer_name" class="form-control" value="{{ old('customer_name') }}" maxlength="255">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3" id="depositAmountWrap" style="display:none;">
                        ...
                        <input type="number" step="0.01" min="0" name="deposit_amount" class="form-control" value="{{ old('deposit_amount') }}" placeholder="Nhập số tiền">
                    </div>
